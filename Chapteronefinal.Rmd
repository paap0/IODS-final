...
Altogether 35% are going out frequently, 33% not often but not rarely, and 32% quite rarely. Health status is defined as very bad or bad as often as in almost every fourth respondent. Very good or good health status is very common, though (55%). A little more than every tenth student has one or more class failures whereas 87% have none. School absences are within 6 or less hours in 77% of the cases. 
...
Performance groups represent approximately the lowest, middle low, middle high and highest groups. Very low or low alcohol consumers both at weekdays and during weekends are 60% or the respondents.However, there seems to be an expected trend towards males drinking more.
...
Interesting relations among the variables can be captured as simply as by using a stratified table. Males drink more than females, as do the younger ones as well.Father큦 job affects alcohol consumption as well, but mother큦 job, guardian or family relationships seem not to. Going out is associated with alcohol usage, but health group seems not to. Class failures are more common among the heavy alcohol users, as well as the highest numbers of school absences. Mean final grade differs significantly between the groups (mean(sd)): 11.74(3.43) versus 11.06(3.04).
&nbsp;
...
Simple form of analysing categorical data is cross-tabulation.  Correspondence analysis is an extention of contingency table data and a generalization of principal component approach. It can be used as a multivariate descriptive data analytic technique and to reduce data dimensionality. Furthermore, the graphical interpretation of the data is a useful tool in exploratory research.
...
MCA() function that come in the package "FactoMineR" by Francois Husson, Julie Josse, Sebastien Le, and Jeremy Mazet. Additionally, package "factoextra" is used. MCA is carried out.
...
Variable categories related results can be extracted separately and provides information on the coordinates, the cos2 and the contribution of variable categories:
...
Indibiduals can be coloured by groups and a concentration ellipse can be added around each group.
...
Firstly, there is a group up in the graph having in common one or more failures, lowest performance group, negative attitude towards higher eduction, high alcohol consumption,
age above 17, father큦 low education, going out frequently, mother working as "other", mothers low education and being a male. Additionally, there have low frequencies for no class failures, mother큦 and father큦 high education, positive attitude towards education, low alcohol consumption, being young, having mother in education, best performance group, being a female and having father in education.

Secondly, there is a group sharing high frequency for mother and father being highly educated, mother and father working as educators, no class failures, performing best, being active and young, mother working in the health sector having family support. In addition there is low frequency for mother눼s or fathers low education, jobs as other, mother at home, one or more class failures, no activities, lowest performance group, average health and no family support.
...
<img src="Rplot.png" alt="" width="1000" height="1000">
</div>
